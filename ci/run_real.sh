...
# transpose decision out of the k loop -- and is now 3.76x faster at these
# shapes, so the ratio fell from 5.62x to 2.65x with the tensor path completely
# unchanged (29.6 and 44.4 cycles per element either way). The
